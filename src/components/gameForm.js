          ...
          <Formik
            ...
            render={({
              ...
              >
                ...
                <p>
                  We need contact information for the person submitting the game
                </p>
                ...
                <fieldset>
                  <div>
                    <Field
                      className={touched.day1 && errors.day1 ? 'invalid' : ''}
                      id="day1"
                      type="checkbox"
                      value="day1"
                      name="day1"
                  ...
                  <div>
                    <Field
                      className={touched.day2 && errors.day2 ? 'invalid' : ''}
                      id="day2"
                      type="checkbox"
                      value="day2"
                      name="day2"
                ...
                <Field id="excited" type="text" component="textarea" name="excited" />
